...
namespace FiveMinutes.Data
{
    ...
    { 
        ...
        public static async Task SeedUsersDefailt(IApplicationBuilder applicationBuilder)
        {
            ...
            await AddUser(applicationBuilder, "golik.tima@gmail.com", "golikdev", "Coding@1234?", UserRoles.Admin);
            await AddUser(applicationBuilder, "ivan.ivanovich@yandex.ru", "Иван Иванович", "123456", UserRoles.Student);
            await AddUser(applicationBuilder, "michail.zukov@kontur.ru", "Михаил Зюков", "123456", UserRoles.Student);
            await AddUser(applicationBuilder, "maria.filatova@mail.ru", "Мария Филатова", "123456", UserRoles.Teacher);
        }
    }
}
