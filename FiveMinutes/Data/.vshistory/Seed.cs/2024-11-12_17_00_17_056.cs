    ...
    { 
        ...
        public static async Task SeedUsersDefailt(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                await AddUser(userManager, "golik.tima@gmail.com", "golikdev", "Coding@1234?", UserRoles.Admin);
                if (await userManager.FindByEmailAsync("golik.tima@gmail.com") != null)
                    Console.WriteLine("YESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSs");
                else
                    Console.WriteLine("NOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOo");
                await AddUser(userManager, "g.t@gmail.com", "golikdev", "Coding@1234?", UserRoles.Student);
