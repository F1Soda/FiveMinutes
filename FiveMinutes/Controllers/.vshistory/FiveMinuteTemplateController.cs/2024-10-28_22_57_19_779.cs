...
namespace FiveMinutes.Controllers
{
	public class FiveMinuteTemplateController : Controller
	{
		...
		public IActionResult Edit(FiveMinuteTemplateEditViewModel fmt)
		{
			var fmtViewModel = TempData["FmtViewModel"] as FiveMinuteTemplateEditViewModel;
			if (fmtViewModel == null)
			{
				// Handle the case where the view model is not found in TempData
