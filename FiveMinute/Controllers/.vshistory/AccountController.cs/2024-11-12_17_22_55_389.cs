...
namespace FiveMinutes.Controllers
{
    ...
    { 
        ...
        public async Task<IActionResult> Detail(string userId)
        {
            ...
            bool isTeacher = currentUserRoles.Contains("Teacher");
            bool isViewingOwnProfile = currentUser.Id == userId;

            if (!(isAdmin || isTeacher || isViewingOwnProfile))
            {
            ...
            var viewedUserRoles = await UserManager.GetRolesAsync(user);
            var role = viewedUserRoles.FirstOrDefault();
