    ...
    { 
        ...
        public static async Task SeedUsersDefailt(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
				...
				await AddUser(userManager, "michail.zukov@kontur.ru", "Михаил Зюков", "123456", UserRoles.Student);
                await AddUser(userManager, "maria.filatova@mail.ru", "Мария Филатова", "123456", UserRoles.Teacher);
            }
        }
