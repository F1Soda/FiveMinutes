...
namespace FiveMinutes.Controllers
{
    public class FiveMinuteTemplateController : Controller
    {
        ...
        {
			return View("Error", new ErrorViewModel("KEK"));

			var currentUser = await userManager.GetUserAsync(User);

            if (currentUser == null)
            {
                throw new ApplicationException($"Attempt to create FMT by non register user");
            }
            ...
            throw new ApplicationException("Fail to add FMT to db");
        }
